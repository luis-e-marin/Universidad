...
public class Main {
    public static void main(String[] args) {
        ...
        Bicicleta bicicleta1 = new Bicicleta("54789", "GW", "X34RT", "Azul");
       ...
       //Crear Mecanico
        ...
        //Crear Repuestos
        Repuesto repuesto = new Repuesto("Pastilla de frenos",15,15.000);
        ...
        Tarea tarea1 = new Tarea("Frenos",45.000);

        //Crear Servicio
        Servicio servicio = new Servicio("14ti58",bicicleta1,"Cambio de pastillas de freno", LocalDate.of(2025,12,5));
        servicio.asignarMecanico(mecanico1);
        servicio.agregarTarea(new Tarea("Cambio de frenos", 45.000));
        servicio.agregarRepuesto(new Repuesto("Pastilla de freno", 2, 15.000));
